...
df = stack(paste0("/Users/", Sys.info()[7], "/Dropbox (MBA)/Kisei_files/original_files/COBESST/COBE_sst.nc"), varname = "sst")
...
save(df, file = paste0("/Users/", Sys.info()[7], "/Dropbox (MBA)/Kisei_files/data/COBE_SST.RData"))
#save(df, file = paste0("/Users/", Sys.info()[7], "/Dropbox (MBA)/PAPER Kisei heat extremes/data/COBE_SST.RData"))


#Hadley
df = stack(paste0("/Users/", Sys.info()[7], "/Dropbox (MBA)/Kisei_files/original_files/HadISST/HadI_sst.nc"), varname = "sst")
...
assign("df", df, .GlobalEnv)
save(df, file = paste0("/Users/", Sys.info()[7], "/Dropbox (MBA)/Kisei_files/data/HadI_SST.RData"))
#save(df, file = paste0("/Users/", Sys.info()[7], "/Dropbox (MBA)/PAPER Kisei heat extremes/data/HadI_SST.RData"))


#ERSST
df = stack(paste0("/Users/", Sys.info()[7], "/Dropbox (MBA)/Kisei_files/original_files/ERSST/ERSSTv5.nc"), varname = "sst")
...
save(df, file = paste0("/Users/", Sys.info()[7], "/Dropbox (MBA)/Kisei_files/data/ER_SST.RData"))
