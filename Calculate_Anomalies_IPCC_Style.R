...
load("~/extreme_normalizations/COBE_Normal_SST_Anomalies_2019.RData"); cobe = anom; cobe$data = "COBE"; cobe$anom = rowMeans(cobe[3:14])
load("~/extreme_normalizations/HadI_Normal_SST_Anomalies_2019.RData"); hadi = anom; hadi$data = "HadI"; hadi$anom = rowMeans(hadi[3:14])
