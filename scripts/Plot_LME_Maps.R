...
load(paste0("/Users/kisei/extreme_normalizations/outputs/HadI/extremes_1980-1989_", cutoff, ".RData")); hadi1 = anom; hadi1$source = "HadISST v1.1"; hadi1$period = "1980-1989"
load(paste0("/Users/kisei/extreme_normalizations/outputs/HadI/extremes_1990-1999_", cutoff, ".RData")); hadi2 = anom; hadi2$source = "HadISST v1.1"; hadi2$period = "1990-1999"
load(paste0("/Users/kisei/extreme_normalizations/outputs/HadI/extremes_2000-2009_", cutoff, ".RData")); hadi3 = anom; hadi3$source = "HadISST v1.1"; hadi3$period = "2000-2009"
load(paste0("/Users/kisei/extreme_normalizations/outputs/HadI/extremes_2010-2019_", cutoff, ".RData")); hadi4 = anom; hadi4$source = "HadISST v1.1"; hadi4$period = "2010-2019"
load(paste0("/Users/kisei/extreme_normalizations/outputs/COBE/extremes_1980-1989_", cutoff, ".RData")); cobe1 = anom; cobe1$source = "COBE v2"; cobe1$period = "1980-1989"
load(paste0("/Users/kisei/extreme_normalizations/outputs/COBE/extremes_1990-1999_", cutoff, ".RData")); cobe2 = anom; cobe2$source = "COBE v2"; cobe2$period = "1990-1999"
load(paste0("/Users/kisei/extreme_normalizations/outputs/COBE/extremes_2000-2009_", cutoff, ".RData")); cobe3 = anom; cobe3$source = "COBE v2"; cobe3$period = "2000-2009"
load(paste0("/Users/kisei/extreme_normalizations/outputs/COBE/extremes_2010-2019_", cutoff, ".RData")); cobe4 = anom; cobe4$source = "COBE v2"; cobe4$period = "2010-2019"
load(paste0("/Users/kisei/extreme_normalizations/outputs/ER/extremes_1980-1989_", cutoff, ".RData")); er1 = anom; er1$source = "ERSST v5"; er1$period = "1980-1989"
load(paste0("/Users/kisei/extreme_normalizations/outputs/ER/extremes_1990-1999_", cutoff, ".RData")); er2 = anom; er2$source = "ERSST v5"; er2$period = "1990-1999"
load(paste0("/Users/kisei/extreme_normalizations/outputs/ER/extremes_2000-2009_", cutoff, ".RData")); er3 = anom; er3$source = "ERSST v5"; er3$period = "2000-2009"
load(paste0("/Users/kisei/extreme_normalizations/outputs/ER/extremes_2010-2019_", cutoff, ".RData")); er4 = anom; er4$source = "ERSST v5"; er4$period = "2010-2019"
...
statarea<-rgdal::readOGR("/Users/kisei/Google Drive/Research/GIS/LME66/LMEs66.shp")
...
if (mode == "annual") {
  ...
  pdf(paste0("/Users/kisei/Desktop/SST_Anomalies_Annual_", cutoff, ".pdf"), height = 5, width = 5)
  # png(paste0("/Users/kisei/Desktop/Fig1_", Sys.Date(), "_", cutoff, ".png"), height = 3, width = 9, units = "in", res = 500)
  print(p)
  dev.off()
...
if (mode == "seasonal") {
  ...
  pdf(paste0("/Users/kisei/Desktop/SST_Anomalies_Season_", cutoff, ".pdf"), height = 5, width = 10)
  # png(paste0("/Users/kisei/Desktop/Fig2_", Sys.Date(), "_", cutoff, ".png"), height = 6, width = 9, units = "in", res = 300)
  print(p)
  dev.off()
