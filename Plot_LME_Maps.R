...
invert_geom_defaults()
  ...
  load(paste0("/Users/kisei/extreme_normalizations/results/HadI/SST_Anomalies_1980-1989_", cutoff, ".RData")); hadi1 = anom; hadi1$source = "HadISST v1.1"; hadi1$period = "1980-1989"
  ...
  load(paste0("/Users/kisei/extreme_normalizations/results/COBE/SST_Anomalies_1980-1989_", cutoff, ".RData")); cobe1 = anom; cobe1$source = "COBE v2"; cobe1$period = "1980-1989"
  ...
  load(paste0("/Users/kisei/extreme_normalizations/results/ER/SST_Anomalies_1980-1989_", cutoff, ".RData")); er1 = anom; er1$source = "ERSST v4"; er1$period = "1980-1989"
  ...
  statarea<-rgdal::readOGR("C:/Users/Kisei/Google Drive/Research/GIS/LME66/LMEs66.shp")
  ...
  if (mode == "annual") {
    ...
    p = ggplot(anom_i) +
      geom_raster(aes(x = x, y = y, fill = sum), interpolate = F) +
      ...
      facet_grid(LME_NAME ~ period, scales = "free") +
      theme_pubr(I(14)) +
    ...
    # pdf(paste0("/Users/kisei/Desktop/Fig1_", Sys.Date(), "_", cutoff, ".pdf"), height = 4, width = 8)
    png(paste0("/Users/kisei/Desktop/Fig1_", Sys.Date(), "_", cutoff, ".png"), height = 3, width = 9, units = "in", res = 300)
    print(p)
    dev.off()
  ...
  if (mode == "seasonal") {
    ...
    p = ggplot(anom_i) +
      ...
      scale_x_continuous(expand = c(-0.005, 0), "") +
      scale_y_continuous(expand = c(-0.005, 0), "") +
      facet_grid(season ~ period, scales = "free") +
      theme_pubr(I(14)) +
      theme(axis.title.x = element_blank(),
            axis.title.y = element_blank(),
            axis.text.x = element_blank(),
